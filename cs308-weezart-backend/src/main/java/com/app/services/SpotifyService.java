...
public class SpotifyService {
	...
	public List<Artist> artistSearch(String query, String accessToken)
	...
	public List<Song> songSearch(String query, String accessToken)
			throws JsonMappingException, JsonProcessingException {
	...
	public List<Album> albumSearch(String query, String accessToken)
			throws JsonMappingException, JsonProcessingException {
		String searchUrl = "https://api.spotify.com/v1/search?q=" + query + "&type=album&limit=5";
		HttpHeaders headers = new HttpHeaders();
