...
function SpotifyRecomPage({ ...props }) {
  ...
  const fetchData = async () => {
    try {
      const songList = await SpotifyRecom(props.token, localStorage.getItem("spotifyToken"));

      console.log("gelen şarkılar sayfadaaa. ", songList);
      ...
      console.log("sayfada şarkılar: ", songs)
  ...
  return (
    <div className="table-container">
        ...
        {console.log("div içinde songs: ", songs)}
...
export default SpotifyRecomPage;
